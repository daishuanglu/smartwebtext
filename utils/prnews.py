...
from utils import prnews_company, string_utils, manager
...
class websearch():
    ...
    HEADERS = ['Company', 'Stock', 'date', 'Title','Body', 'Link']
    ...
    def scrap_rule0(self, uri, company_name, login=None, loginform=None):
        ...
        content = content.replace(TABLE_COL_BREAK, ' ')
        ...
        with open(self.output_file, 'a', encoding='utf-8') as f:
            output_line = string_utils.ignore_unicode_char(
                TABLE_COL_BREAK.join(output_str))+'\n' 
            f.write(output_line)
        return soup
...
def main():
    ...
    parser.add_argument(
        '--kw_search_counts', required=False, default='{}',
